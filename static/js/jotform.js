        ...
        var ready = function () {
            try {
                ...
                var constructFooterPowered = function(){
                    ...
                    footerText.innerText = "Now create your own JotForm - It's free forever";
...
//                        p.$jot('.jt-content, .jt-title').css('width', 'auto');
    ...
    checkCalculation: function (calc) {
        ...
        try {
            if (!['text', 'email', 'textarea', 'calculation', 'combined', 'address', 'datetime', 'time', 'html', 'authnet', 'paypalpro', 'number', 'radio', 'checkbox', 'select', 'matrix', 'braintree', 'stripe', 'square', 'eway', 'bluepay'].include(JotForm.calculationType(result))) return;
        } catch (e) {
            console.log(e);
        }
